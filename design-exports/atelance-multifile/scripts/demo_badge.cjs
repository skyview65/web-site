...
function a(){
  ...
  s.textContent="#__demo_badge__{position:fixed;left:50%;bottom:15px;transform:translateX(-50%);z-index:2147483647;pointer-events:none;font-family:ui-sans-serif,system-ui,-apple-system,'Segoe UI',sans-serif;font-size:10px;line-height:1;letter-spacing:.26em;text-transform:uppercase;white-space:nowrap;color:rgba(255,255,255,.86);background:rgba(10,10,12,.6);-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px);border:1px solid rgba(255,255,255,.2);border-radius:999px;padding:8px 15px;box-shadow:0 4px 22px rgba(0,0,0,.4)}@media(max-width:560px){#__demo_badge__{font-size:8px;letter-spacing:.2em;padding:6px 11px;bottom:10px;opacity:.85}}";
