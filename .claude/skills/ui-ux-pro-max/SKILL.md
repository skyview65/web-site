...
- **Stack**: Detect from the project — supported stacks: React, Next.js, Vue, Svelte, Astro, Nuxt.js, Nuxt UI, SwiftUI, React Native, Flutter, HTML/Tailwind, shadcn/ui, Jetpack Compose, Three.js, Angular, Laravel
...
| Icon recommendations | `icons` | `--domain icons "navigation settings menu"` |

### Step 4: Stack Guidelines

Get implementation-specific best practices for your project's stack (replace `<stack>` with one of the supported stacks listed below):
...
| `icons` | Icon library recommendations | navigation, settings, search, lucide, heroicons |
