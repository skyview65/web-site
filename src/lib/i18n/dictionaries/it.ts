...
export const it = {
  ...
  game: {
    eyebrow: "DEMO GIOCABILE",
    title: "FUGA NEON",
    tagline: "Guida la tua hover-bike nel canyon al neon. Passa i varchi nei muri di droni di PANOPT, raccogli Lümen e non farti prendere.",
    start: "INIZIA",
    restart: "RIPROVA",
    controls: "↑ ↓ / W S o trascina il dito",
    distance: "DISTANZA",
    lumen: "LÜMEN",
    best: "RECORD",
    threat: "PANOPT",
