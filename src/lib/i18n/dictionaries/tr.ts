...
export const tr = {
  ...
  game: {
    ...
    title: "NEON SOKAKLAR",
    tagline: "LUMENFALL'un neon sokaklarında birinci şahıs yürüyüşe çık. Hedef yok, kovalamaca yok — yağmur altında yaşayan şehri, gökyüzü trafiğini ve yayaların arasında özgürce keşfet.",
    choose: "Karakterini seç",
    start: "ŞEHRE GİR",
    restart: "TEKRAR DENE",
    controls: "WASD yürü · Fare/sürükle bak · Shift koş",
    distance: "MESAFE",
    lumen: "LÜMEN",
    best: "REKOR",
    threat: "PANOPT",
