...
export const fr = {
  ...
  game: {
    eyebrow: "DÉMO JOUABLE",
    title: "FUITE NÉON",
    tagline: "Pilote ton hover-bike dans le canyon néon. Passe les brèches des murs de drones de PANOPT, récupère des Lümen, ne te fais pas prendre.",
    start: "DÉMARRER",
    restart: "REJOUER",
    controls: "↑ ↓ / W S ou glisse ton doigt",
    distance: "DISTANCE",
    lumen: "LÜMEN",
    best: "RECORD",
    threat: "PANOPT",
