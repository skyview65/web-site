...
export const es = {
  ...
  game: {
    eyebrow: "DEMO JUGABLE",
    title: "FUGA NEÓN",
    tagline: "Pilota tu hover-moto por el cañón de neón. Cruza los huecos de los muros de drones de PANOPT, recoge Lümen y no dejes que te atrapen.",
    start: "EMPEZAR",
    restart: "REINTENTAR",
    controls: "↑ ↓ / W S o arrastra el dedo",
    distance: "DISTANCIA",
    lumen: "LÜMEN",
    best: "RÉCORD",
    threat: "PANOPT",
