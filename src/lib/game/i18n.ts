...
const en: Dict = {
  ...
  "death.revive": "📺 Watch ad → respawn ({n} left)",
  "death.reviveHint": "Continue this round with {p}% of your mass",
  ...
  // revenue & retention surfaces
  "shop.pity": "Epic+ guaranteed within {n} 📦",
  "shop.freeCrate": "📺 FREE crate — watch ad",
  "shop.freeCrateIn": "Next free crate in {t}",
  "shop.deal": "⭐ DAILY DEAL",
  "shop.dealBuy": "Get it — {n} 💰",
  "shop.dealGone": "✅ Deal claimed today",
  "shop.collection": "Collection {owned}/{total}",
  "shop.collectionClaim": "{pct}% milestone → claim +{n} 💰",
  "menu.doubleDaily": "📺 2×",
  "menu.doubleDailyDone": "✅ 2×",
  "menu.comeback": " · 🎉 comeback bonus!",
  "menu.reroll": "📺 reroll",
  "menu.level": "Aura Lv.{n}",
  "results.xpBoost": "⚡ 2× XP · {n} boosted rounds left today",
  "results.teaser": "🎯 {label} — {n} to go!",
  "results.teaserDone": "🎯 Mission complete — claim it in the menu!",
  "ann.levelup": "AURA LEVEL {n}!",
  "ann.levelup.sub": "+{c} 💰",
};
...
const tr: Dict = {
  ...
  "death.revive": "📺 Reklam izle → geri dön ({n} hak)",
  "death.reviveHint": "Kütlenin %{p}'i ile aynı turda devam et",
  ...
  "card.arena": "ARENA {code}",
  // gelir & retention yüzeyleri
  "shop.pity": "{n} 📦 içinde garanti Epik+",
  "shop.freeCrate": "📺 BEDAVA kasa — reklam izle",
  "shop.freeCrateIn": "Sonraki bedava kasa: {t}",
  "shop.deal": "⭐ GÜNÜN FIRSATI",
  "shop.dealBuy": "Hemen al — {n} 💰",
  "shop.dealGone": "✅ Bugünün fırsatı alındı",
  "shop.collection": "Koleksiyon {owned}/{total}",
  "shop.collectionClaim": "%{pct} kilometre taşı → +{n} 💰 al",
  "menu.doubleDaily": "📺 2×",
  "menu.doubleDailyDone": "✅ 2×",
  "menu.comeback": " · 🎉 dönüş bonusu!",
  "menu.reroll": "📺 yenile",
  "menu.level": "Aura Sv.{n}",
  "results.xpBoost": "⚡ 2× XP · bugün {n} hızlı tur hakkın kaldı",
  "results.teaser": "🎯 {label} — {n} kaldı!",
  "results.teaserDone": "🎯 Görev tamam — menüden ödülünü al!",
  "ann.levelup": "AURA SEVİYE {n}!",
  "ann.levelup.sub": "+{c} 💰",
};
